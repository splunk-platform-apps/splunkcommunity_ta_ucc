...
def get_account_api_key(session_key: str, account_name: str):
    cfm = conf_manager.ConfManager(
        ...
        realm=f"__REST_CREDENTIAL__#{example_utils.ADDON_NAME}#configs/conf-splunkcommunity_ta_uccexample_account",
    )
    account_conf_file = cfm.get_conf("splunkcommunity_ta_uccexample_account")
    ...
    for input_name, input_item in inputs.inputs.items():
        ...
        try:
            ...
            log_level = conf_manager.get_log_level(
                ...
                conf_name="splunkcommunity_ta_uccexample_settings",
            )
            ...
            for incident in data["incidents"]:
                ...
                created_at = datetime.strptime(
                    incident["created_at"], "%Y-%m-%dT%H:%M:%S.%f%z"
                ).timestamp()
